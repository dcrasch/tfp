...
{
    TFigure_type *t1 =
	TFigureCreate(0.4, 80, 80, 0, 0, TWO_PI, 40, 40, "Square");
...
{
    TFigure_type *t1 =
	TFigureCreate(0.4, 100, 50, 50, 0, TWO_PI, 40, 40, "Square2");
    t1->rootnode =
	TLinenodeCreateXY(0, 0, 0, 50, 100, 0, 100, 50, 0, NULL);
...
{
    TFigure_type *t1 =
	TFigureCreate(0.3, 160, 160, 0, 0, HALF_PI, 40, 40, "Square90");
    t1->rootnode =
	TLinenodeCreateXY(0, 0, 0, 80, 0, 0, 80, 0, -HALF_PI, NULL);
    TLinenodeAdd(t1->rootnode, 80, 80, 0, 80, 80, 80, 80, 0, HALF_PI);
    return t1;
}
...
{
    TFigure_type *t1 =
	TFigureCreate(0.5, 225, 65, 113, 0, 2 * THIRD_PI, 25, 50,
		      "Diamond");
    t1->rootnode =
	TLinenodeCreateXY(38, 65, 113, 65, 38, 65, 0, 0, -2 * THIRD_PI,
			  NULL);
...
{
    TFigure_type *t1 =
	TFigureCreate(0.4, 300, 87, 150, 0, THIRD_PI, 80, 40, "Triangle");
    t1->rootnode =
	TLinenodeCreateXY(0, 0, -50, 87, 0, 0, 50, 87, -THIRD_PI, NULL);
...
{
    TFigure_type *t1 =
	TFigureCreate(0.4, 80, 80, 40, 0, TWO_PI, 40, 40, "Brick");
    t1->rootnode = TLinenodeCreateXY(0, 0, 0, 80, 80, 0, 80, 80, 0, NULL);
...
{
    TFigure_type *t1 =
	TFigureCreate(0.5, 86, 43, 43, 0, TWO_PI, 40, 70, "SquareN8");
